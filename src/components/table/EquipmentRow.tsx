...
const EquipmentRow: FC<EquipmentRowProps> = ({ equipment, onSelect }) => (
    ...
    >
        <td className="px-3 py-2 whitespace-nowrap">
            <div className="font-medium text-gray-800 text-xs">{equipment.name}</div>
        </td>
        <td className="px-3 py-2 whitespace-nowrap">
            <div className="text-gray-500 text-xs">{equipment.type}</div>
        </td>
        <td className="px-3 py-2 whitespace-nowrap">
            <div className="flex items-center">
                <span 
                    ...
                    aria-hidden="true"
                />
                <span className="text-xs">{equipment.state}</span>
            </div>
        </td>
    </tr>
);
